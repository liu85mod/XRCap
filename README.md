...
XRCap 核心录制功能**完全免费**。但如果您追求**视频极致的录制速度**与**突破极限的画质**，欢迎支持我们的项目，升级至 **XRCap PRO**！
...
4. 启动游戏，按下快捷键 `F6` 呼出控制面板，或点击左侧图标 <img src="./Resource/xrcap_icon_off.png" width="32" alt="XRCap Logo" align="center">
